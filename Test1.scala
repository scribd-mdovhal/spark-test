...
object TestApp extends {
  ...
  def main(args: Array[String]): Unit = {
    ...
    //+-------------+---------------------+---+
    //|0            |2006-10-24 03:00:38.0|95 |
    //|0            |2006-11-06 10:28:41.0|150|
    //+-------------+---------------------+---+
    ...
    :     +- *(1) FileScan parquet test.documents[created_at#3,document_type#18] Batched: true, Format: Parquet, Location: InMemoryFileIndex[hdfs://, PartitionFilters: [], PushedFilters: [IsNotNull(created_at), IsNotNull(document_type)], ReadSchema: struct<created_at:string,document_type:tinyint>
